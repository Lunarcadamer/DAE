        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row modify-section">
                    <div class="col-md-6">
						<h2 class="modify-title">Adding a New Genre</h2>
						<form action="ProcessAddGenre.jsp" method="post">
							<div class="form-group">
							
								<label for="genreInput">Genre Name:</label>
								<input type="text" id="genreInput" class="form-control" name="genreName"/><br/>
								
								<label for="gameInput">Games Associated (Eg. Skyrim,Fallout 4,Dota 2):</label>
								<input type="text" id="gameInput" class="form-control" name="games"/><br/>
