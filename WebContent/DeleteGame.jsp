                    ...
                    <div class="col-md-6">
                       	<%
							...
							try {
								...
								PreparedStatement pstmt = conn.prepareStatement("SELECT gameTitle FROM game WHERE gameID = ?");
						...
						%>
						<h2 class="modify-title">Deleting <%=gameTitle%></h2>
							<form action="ProcessDeleteGame.jsp" method="post">
								<div class="form-group">
									<input type="hidden" name="gameID" class="form-control" value="<%=gameID%>">
									<input type="hidden" name="gameTitle" class="form-control" value="<%=gameTitle%>">
									<label for="gameTitleInput">Confirm Deletion of <%=gameTitle%>?</label>
